...
- Register home data dependencies in `HomeDataModule.kt` (`repositoryModule`/`databaseModule`). Follow the equivalent data/presentation modules for other features.
